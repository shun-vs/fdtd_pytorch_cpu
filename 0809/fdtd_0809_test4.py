...
# 音源位置をメッシュの重心から自動設定
x_source, y_source, z_source = mesh.centroid
print(f"\nメッシュの重心を音源位置として自動設定: ({x_source:.3f}, {y_source:.3f}, {z_source:.3f})")

print("\nTrimeshによるボクセル化を開始します...")
voxel_grid = mesh.voxelized(pitch=dx, max_iter=20)

### ▼▼▼ 新しい修正箇所: 強制的な内部充填 ▼▼▼ ###
# ボクセル化されたグリッドの内部を強制的に埋める
print("ボクセルグリッドの内部を強制的に充填します...")
