...
### ▼▼▼ 設定項目 ▼▼▼ ###
stl_path = r'./sample.stl'
absorption_path = r'./absorption_data.json'
output_path = r'./sound_animation_voxelized.mp4'
dx = dy = dz = 0.005
tmax = 0.005
...
if cfl_number > 1: print("\n警告: 安定条件を満たしていません。"); sys.exit()
...
# pitchをdxに合わせることで、FDTDグリッドと完全に一致させる
voxel_grid = mesh.voxelized(pitch=dx, max_iter=20)
# VoxelGridオブジェクトから、原点とブーリアンマスクを取得
